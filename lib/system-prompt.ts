...
- Never call an image tool because of an earlier turn; image tools are valid only when the current user message explicitly requests image creation or editing.
